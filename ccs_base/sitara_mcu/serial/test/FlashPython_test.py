...
def main():
    ...
    propertiesMap = {'COMPort':com_str, 'partnum':"", 'FlashOperationType':"", 'FlashAppOffset':"", 'FlashSectorSize':"", 'FlashBoardType':"EVM", 'CustomFlashEnable' : False ,'FlasherCustomPath':"",'FlasherCustomName':"sbl_uart_uniflash.release.tiimage"}
