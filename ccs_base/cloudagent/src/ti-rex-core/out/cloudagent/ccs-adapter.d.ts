...
export declare const ccsPackageChangesFileName = "ccs_package_changes.json";
/**
...
export declare class CCSAdapter extends CCSAdapterBase {
    ...
    private readonly ccsPackageChangesPath;
    constructor(logger: Logger, desktopQueue: PQueue, ccsPort: number, isTheia: boolean, vars: Vars, progressManager: ProgressManager, triggerEvent: TriggerEvent);
    start(): Promise<void>;
    close(): void;
    /**
    ...
    /**
     * Get the list of installed packages from CCS.
     */
