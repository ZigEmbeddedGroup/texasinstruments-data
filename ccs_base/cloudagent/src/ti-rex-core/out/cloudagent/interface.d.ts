...
import type { EntryModuleDesktop } from './entry-module-inner-desktop';
import type { EntryModuleCloud } from './entry-module-inner-cloud';
import type { PromiseResult } from '../shared/generic-types';
