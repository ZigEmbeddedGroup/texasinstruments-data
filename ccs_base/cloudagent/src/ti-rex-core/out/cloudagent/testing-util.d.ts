...
export declare function waitForCall(stub: sinon.SinonStub): Promise<void>;
export declare function waitForCallWithArgs(stub: sinon.SinonStub, matchingArg: any): Promise<void>;
