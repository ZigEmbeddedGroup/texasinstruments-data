...
export type ViewLimitation = 'aws' | 'e2e' | 'guicomposer' | 'h264codec' | 'nohttps' | 'parasoft' | 'elprotronic' | 'xeltex' | 'hilosystems' | 'tlsmbed' | 'tiSensortag' | 'tiTraining' | 'tiC2000' | 'tiWiki' | 'zipLink';
...
export type ProjectFile = ProjectFolder | ProjectFileLink;
export type ProjectFileLink = string;
