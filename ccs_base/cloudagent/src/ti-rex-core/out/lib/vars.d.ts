...
export interface DesktopServerVars {
    enabled: boolean;
    dataDir: string;
    dbDir: string;
    db3Dir: string;
    logDir: string;
    globalMetadataDir: string;
    tmpDir: string;
    advanced: DesktopServerAdvancedVars;
}
export interface DesktopServerAdvancedVars {
    desktopServerHostOverride?: string;
    forceImportOnStart: boolean;
    maxSoftwarePackages?: number;
    allowProductionPackagesOnly?: boolean;
    includeSoftwarePackages?: string;
    excludeSoftwarePackages?: string;
}
export declare class Vars {
    ...
    static LOCAL_DB_DIR?: string;
    static BIN_BASE_PATH: string;
    static LOCAL_DATA_CACHE_DIR: string;
