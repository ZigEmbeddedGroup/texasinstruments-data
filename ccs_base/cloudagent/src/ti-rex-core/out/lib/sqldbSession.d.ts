...
import { FilterData, Compiler, Kernel, BoardsAndDevicesData, GlobalMetadataData } from '../shared/routes/response-data';
...
declare class SqldbSession implements DbSession {
    ...
    private readonly globalMetadataData;
    ...
    getGlobalMetadataData(): GlobalMetadataData;
    ...
    lookupNodeDbIdOnPublicId(nodePublicId: string, packageGroup: {
        publicId: string;
        version: string;
    } | null, packagePublicId: string | null, fallbackToLatest?: boolean): Promise<number | null>;
...
export declare class SqldbSessionFactory {
    ...
    invalidate(): void;
    /**
     * Invalidates the current session and reloads the database in a new sqldb instance
     */
    invalidateAndReload(setupNewDatabase: () => void): void;
}
export {};
