...
export type TrunkJsonBaseNode = {
    children?: TrunkJsonNode[];
};
export interface TrunkJsonNode extends TrunkJsonBaseNode {
    name: string;
    publicId: string;
    type?: TrunkNodeType;
}
export type TrunkJsonRootNode = TrunkJsonBaseNode;
export interface TrunkJson {
    root: TrunkJsonRootNode;
}
export interface ForeignKey {
    table: keyof Tables;
    column: string;
    referencedTable: keyof Tables;
}
/**
...
export declare class Manage {
    ...
    private contentDirSeqNoByPackageUid;
    ...
    /**
     * Get the timestamp of the database's latest published update
     */
    getDatabaseUpdateTimestamp(): Promise<number | null>;
    /**
     ...
     */
    checkDatabaseReferentialIntegrity(): Promise<ForeignKey[]>;
    /**
    ...
    private writeResourceProjFilesToDb;
    private processProjectFileTree;
    private writeNodePublicIdsToDb;
...
export declare function getLinkExt(link?: string | null): string | null;
export {};
