...
export interface DbPackage extends PersistentDbObj {
    ...
    descriptionAsDependency: string | null;
    path: string;
    image: string | null;
    order: number | null;
    semver: string;
...
export declare function createVirtualReadmeFilePublicId(projectPublicId: string): string;
export declare function publicIdReadmeFilePart(seq: number, type: 'readme-md' | 'readme-non-md'): string;
/**
...
export declare function signedBigInt64ToUnsigned(signed: bigint): bigint;
export declare function unsignedBigToSigned(unsigned: string | number | bigint): string | bigint;
export declare function unsignedBigNumberStringToSigned(unsignedString: string): string;
export declare function unsignedBigIntToSigned(unsigned: bigint): bigint;
/**
...
export declare function resourceSortToDb(s?: SortType | null): "d" | "m" | "a";
export declare function dbToProjectRestriction(s: string | null): ProjectRestriction | null;
export declare function projectRestrictionToDb(restriction: ProjectRestriction | null): "d" | "c" | null;
...
/**
 * Convert bigint to number if safe, otherwise return the bigint
 */
export declare function bigintToNumberOrBigint(n: bigint): number | bigint;
/**
 * Convert numeric string to number if safe, otherwise to bigint
 */
export declare function stringToNumberOrBigint(s: string): number | bigint;
