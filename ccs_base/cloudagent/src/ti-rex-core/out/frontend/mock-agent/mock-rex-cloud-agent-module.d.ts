...
export declare class MockRexCloudAgentModule implements Omit<RexCloudAgentModule, 'getSubModule' | 'close' | '_getLogger' | 'getConfig' | 'getLocalInfo' | 'getCcsDevices' | 'getCcsDeviceDetail' | 'getProjectTemplates' | 'getBoardAndDeviceInfo' | 'importProjectTemplate'> {
