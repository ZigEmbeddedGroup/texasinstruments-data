...
import { SearchResultPage } from '../component-helpers/util';
export declare class ApisCacheInterface {
    ...
    getSearchResultsPage(cacheKey: string): SearchResultPage | null;
    ...
    setSearchResultsPage(cacheKey: string, page: SearchResultPage): SearchResultPage;
