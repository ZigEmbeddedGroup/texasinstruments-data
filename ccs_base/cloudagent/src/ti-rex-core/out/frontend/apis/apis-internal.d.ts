...
export declare class APIsInternal {
    ...
    getExtendedNodes(id: string): Promise<import("../../shared/routes/response-data").Nodes.NodeExtended>;
    ...
    getNodeDataForTableItemVariant(tableItemId: string, query: ServerFilterQuery.Params, variant: TableView.TableItemVariant): Promise<Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.LeafNode>>;
    ...
    getSearchResultsPage({ textSearch, pageNum, resultsPerPage, searchEngine, searchEngineId }: SearchQuery): Promise<import("../component-helpers/util").SearchResultPage>;
