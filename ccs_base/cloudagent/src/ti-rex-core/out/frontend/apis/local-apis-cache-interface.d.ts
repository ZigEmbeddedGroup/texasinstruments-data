...
export declare class LocalApisCacheInterface {
    ...
    getLocalInfo(): Promise<import("../../cloudagent/external-apis").LocalInfo> | null;
    ...
    setLocalInfo(localInfo: AgentResponse<'getLocalInfo'>): Promise<import("../../cloudagent/external-apis").LocalInfo>;
