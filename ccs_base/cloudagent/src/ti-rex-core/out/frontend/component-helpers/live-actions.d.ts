...
export declare function importProject(appProps: AppProps, agentMode: AgentMode, publicId: string): Promise<void>;
export declare function importProjectInCurrentPackage(appProps: AppProps, agentMode: AgentMode, nodePublicId: string): Promise<void>;
export {};
