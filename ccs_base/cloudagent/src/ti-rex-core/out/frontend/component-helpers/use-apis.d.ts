...
import { SearchEngine, SearchEngineId } from './util';
...
interface UseGetDynamicPackageDownloadParams extends UseApisBaseParams {
    packages: string[];
}
interface UseGetDynamicPackageDownloadStatusParams extends UseApisBaseParams {
    requestToken: string | null;
    nextDownloadStatusUpdateSeq: number;
}
...
interface UseGetDesktopServerStatusParams extends UseApisBaseParams {
    statusLastChecked: number | null;
}
...
export declare function useGetExtendedNodes(args: UseGetExtendedNodesParams): {
    ...
    shouldDisplayInitalLoadingUI: boolean;
    initalLoadInProgress: boolean;
    result: import("../../shared/routes/response-data").Nodes.NodeExtended | null;
};
...
export declare function useGetNodeDataForTableItemVariant(args: UseGetNodeDataForTableItemVariantParams): {
    ...
    shouldDisplayInitalLoadingUI: boolean;
    initalLoadInProgress: boolean;
    result: Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.LeafNode> | null;
};
...
export declare function useGetDynamicPackageDownload(args: UseGetDynamicPackageDownloadParams): {
    shouldDisplayLoadingUI: boolean;
    shouldDisplayInitalLoadingUI: boolean;
    initalLoadInProgress: boolean;
    result: import("../../shared/routes/request-response").Response.DynamicDownloadRequest | null;
};
export declare function useGetDynamicPackageDownloadStatus(args: UseGetDynamicPackageDownloadStatusParams): {
    shouldDisplayLoadingUI: boolean;
    shouldDisplayInitalLoadingUI: boolean;
    initalLoadInProgress: boolean;
    result: import("../../shared/routes/request-response").Response.DynamicDownloadStatus | null;
};
...
export declare function useGetSearchResultsPage(args: UseGetSearchResultsPageParams): {
    ...
    shouldDisplayInitalLoadingUI: boolean;
    initalLoadInProgress: boolean;
    result: import("./util").SearchResultPage | null;
};
export declare function useGetDesktopServerStatus(args: UseGetDesktopServerStatusParams): {
    shouldDisplayLoadingUI: boolean;
    shouldDisplayInitalLoadingUI: boolean;
    initalLoadInProgress: boolean;
    result: import("../../shared/routes/request-response").Response.DesktopServerStatusData | null;
};
