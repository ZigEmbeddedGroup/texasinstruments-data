...
export declare function setPackageMetadataList(packageMetadataList: Map<string, PackageDefinition>, packageFolder: string, packageBasePath: string, id: string, version: string, type: PackageType): void;
