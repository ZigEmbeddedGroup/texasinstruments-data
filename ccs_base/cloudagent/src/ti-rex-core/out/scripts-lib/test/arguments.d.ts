export namespace options {
    namespace remoteserverOptionsCommon {
        ...
        export { testMode };
        import dbMode = commonOptions.dbMode;
        export { dbMode };
    ...
    namespace loadRemoteserverOptionsCommon {
        ...
        import dbMode_1 = commonOptions.dbMode;
        export { dbMode_1 as dbMode };
    ...
    namespace serverIndependentOptionsCommon {
        ...
        import dbMode_2 = commonOptions.dbMode;
        export { dbMode_2 as dbMode };
    ...
    namespace e2eOptions {
        ...
        import dbMode_3 = commonOptions.dbMode;
        export { dbMode_3 as dbMode };
    }
}
...
export function getOptionsMainProcess(configuration: any): {
    ...
    dbMode: {
        describe: string;
        default: scriptsUtil.DbMode;
        choices: scriptsUtil.DbMode[];
    };
    timeout: {
        describe: string;
        default: number;
...
declare namespace commonOptions {
    ...
    export namespace dbMode_4 {
        let describe_10: string;
        export { describe_10 as describe };
        let _default_3: scriptsUtil.DbMode;
        export { _default_3 as default };
        let choices_1: scriptsUtil.DbMode[];
        export { choices_1 as choices };
    }
    export { dbMode_4 as dbMode };
