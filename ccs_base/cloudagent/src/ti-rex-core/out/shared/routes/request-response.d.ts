...
import { DesktopServerStatus } from '../../desktop-server/desktop-server-manager';
...
export declare namespace RequestQuery {
    ...
    export interface DynamicDownloadRequest {
        packages: string[];
        platform?: Platform;
    }
    export interface DynamicDownloadStatus {
        requestToken: string;
    }
...
export declare namespace RequestQueryInput {
    ...
    type DynamicPackageDownload = RequestQuery.DynamicDownloadRequest;
    type DynamicPackageDownloadStatus = RequestQuery.DynamicDownloadStatus;
...
export declare namespace Response {
    ...
    type DynamicDownloadRequest = DownloadPendingWithRequestToken | DownloadSuccess | DownloadFailure;
    type DynamicDownloadStatus = DownloadPending | DownloadSuccess | DownloadFailure;
    type DownloadPendingWithRequestToken = DownloadPending & {
        requestToken: string;
        requestDonePromise: Promise<void> | null;
    };
    ...
    type DesktopServerStatusData = DesktopServerStatus | undefined;
