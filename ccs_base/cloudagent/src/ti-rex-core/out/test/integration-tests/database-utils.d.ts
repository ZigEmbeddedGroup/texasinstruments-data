...
export declare const firstFoldersInAllPackages: string[];
...
export type MinimalPackageOverview = Partial<Overview> & Pick<Overview, 'name' | 'version' | 'type' | '_id' | 'packagePath' | 'resourceType' | 'packageVersion' | 'packageUId' | 'fullPaths' | 'fullPathsPublicIds' | 'id' | 'packageId' | 'semver' | 'installPath' | 'rootCategory'> & {
