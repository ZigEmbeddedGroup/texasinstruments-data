...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK0_SEC8 | FLASH_BANK0_SEC9 | FLASH_BANK0_SEC10,   ALIGN(8)
   .cinit           : > FLASH_BANK0_SEC10,  ALIGN(8)
   .switch          : > FLASH_BANK0_SEC10,  ALIGN(8)
   .reset           : > RESET,                  TYPE = DSECT /* not used, */

   .stack           : > RAMM1

#if defined(__TI_EABI__)
   .init_array      : > FLASH_BANK0_SEC10,  ALIGN(8)
   .bss             : > RAMLS5
   .bss:output      : > RAMLS3
   .bss:cio         : > RAMLS0
   .data            : > RAMLS5
   .sysmem          : > RAMLS5
   .const           : > FLASH_BANK0_SEC9,  ALIGN(8)
#else
   .pinit           : > FLASH_BANK0_SEC10,  ALIGN(8)
   .ebss            : > RAMLS5
   .esysmem         : > RAMLS5
   .cio             : > RAMLS0
   ...
   IQmath           : > FLASH_BANK0_SEC10, ALIGN(8)
   IQmathTables     : > FLASH_BANK0_SEC9, ALIGN(8)

   .TI.ramfunc      : LOAD = FLASH_BANK0_SEC10,
                      RUN = RAMLS0,
